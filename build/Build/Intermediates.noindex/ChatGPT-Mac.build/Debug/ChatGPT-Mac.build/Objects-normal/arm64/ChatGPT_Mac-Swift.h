...
#ifndef CHATGPT_MAC_SWIFT_H
#define CHATGPT_MAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ChatGPT_Mac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11ChatGPT_Mac13ChatViewModel")
...
SWIFT_CLASS("_TtC11ChatGPT_Mac20FileUploadUIDelegate")
@interface FileUploadUIDelegate : NSObject <WKUIDelegate>
- (void)webView:(WKWebView * _Nonnull)webView runOpenPanelWithParameters:(WKOpenPanelParameters * _Nonnull)parameters initiatedByFrame:(WKFrameInfo * _Nonnull)frame completionHandler:(void (^ _Nonnull)(NSArray<NSURL *> * _Nullable))completionHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
